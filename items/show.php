...
<?php endif; ?>
<?php if(metadata('item', array('Item Type Metadata', 'Interview Cache File'))): ?>
        <div class="item-description-static"><table style="width:100%;text-align:left;"><tr><td style="width:100px;text-align:left;"><h4>OHMS Viewer: </h4></td></tr><tr><td style="width:300px;text-align:left;"><p><iframe src='https://nyx.uky.edu/oh/render.php?cachefile=<?php echo metadata('item', array('Item Type Metadata', 'Interview Cache File')); ?>.xml' width='900px' height='785px' frameborder='0' name="viewer" scrolling="no" ></iframe></p></td></tr></table></div>
<?php endif; ?>
